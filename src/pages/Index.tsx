...
import AlbanianBanksMortgages from '../components/AlbanianBanksMortgages';
import INSTATDataSource from '../components/INSTATDataSource';
import { Button } from '../components/ui/button';
import { Link } from 'react-router-dom';
import { ChevronRight, Calculator, MapPin, BarChart3, LineChart } from 'lucide-react';
  ...
  return (
    <div className={`animate-fade-in space-y-6 ${isMobile ? 'px-2' : 'px-4'}`}>
      <div className="container mx-auto py-6">
        ...
        <div className="reveal-element transition-all duration-700 opacity-0 translate-y-4" style={{ transitionDelay: '300ms' }}>
          <AlbanianBanksMortgages />
        </div>
